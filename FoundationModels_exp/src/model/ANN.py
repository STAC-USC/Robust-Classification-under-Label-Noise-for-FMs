...
def run_ann(Xtr, ytr, Xte, yte, kmin=11, kmax=51):
    """
    Convenience wrapper for ANN: fit on (Xtr, ytr), predict on Xte,
    and return test-set accuracy against yte.
    """
    model = ANN(kmin=kmin, kmax=kmax)
    model.fit(Xtr, ytr)
